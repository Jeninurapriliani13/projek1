...
<form method="POST" action="">
    <h3>Data barang</h3>
    Nama Barang: <input type="text" name="namaBarang" required><br><br>
    Jenis Barang: <input type="text" name="jenisBarang" required><br><br>
    Jumlah Barang: <input type="number" name="jumlahBarang" required><br><br>
